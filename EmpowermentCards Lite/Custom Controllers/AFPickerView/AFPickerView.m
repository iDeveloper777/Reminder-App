...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) 
    {
        ...
        [shadows setFrame:rect];
        [self addSubview:shadows];
        
        // glass
        UIImage *glassImage = [UIImage imageNamed:@"pickerGlass.png"];
        glassImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0.0, 76.0, rect.size.width, glassImage.size.height)];
...
- (void)setup
{
    _rowFont = [UIFont systemFontOfSize:20.0];
    _rowIndent = 30.0;
